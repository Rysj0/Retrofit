...
public class FgNewsFragment extends Fragment {
    ...
    private TableLayout tl_news;
    private ViewPager vp_news;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fg_movie_2,container,false);
    }
    @Override
    public void onViewCreated(View view,Bundle saveInstanceState){
        ...
        tl_news.setupWithViewPaer(vp_news);

    }

    private void setViewPager() {
        fragments.add(FgNewsListFragment.newsListFragment(NEWS_TYPE_TOP));
        fragments.add(FgNewsListFragment.newsListFragment(NEWS_TYPE_NBA));
        fragments.add(FgNewsListFragment.newsListFragment(NEWS_TYPE_JOKES));
