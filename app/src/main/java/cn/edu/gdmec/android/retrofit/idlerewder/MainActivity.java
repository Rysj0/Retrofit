...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,ViewPager.OnPageChangeListener{
    ...
    private ImageView iv_title_movice;
    ...
    private void initView() {
        ...
        iv_title_movice = findViewById(R.id.iv_title_movie);
        ...
        iv_title_movice.setOnClickListener(this);
    ...
    public void setCurrentItem(int i) {
        ...
        iv_title_movice.setSelected(false);
        ...
        switch (i){
            ...
            break;
            case 1:
                iv_title_movice.setSelected(true);
                break;
            case 2:
